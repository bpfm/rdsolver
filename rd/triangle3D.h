...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
                ...
                for(i=0;i<5;i++){
                        SUM_FLUC_N[i] = abs(SECOND_FLUC_N[i][0]) + abs(SECOND_FLUC_N[i][1]) + abs(SECOND_FLUC_N[i][2]) + abs(SECOND_FLUC_N[i][3]);
                        ...
                        FLUC_B[i][3] = THETA_E[i][i]*SECOND_FLUC_N[i][3] + (IDENTITY[i][i] - THETA_E[i][i])*SECOND_FLUC_LDA[i][3];
