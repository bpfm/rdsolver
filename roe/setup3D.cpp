...
centre setup_centre(int N_POINTS, int i, int j, int k, float dx){
        ...
        if(IC == 0){
                ...
                new_centre.set_x_velocity(0);                          // units m/s
                new_centre.set_y_velocity(0);                          // units m/s
                new_centre.set_z_velocity(0);                          // units m/s
                new_centre.set_pressure(1);                            // units N/m^2
    
                if(x > (50/2 - dx) and x < (50/2 + dx) and y > (50/2 - dx) and y < (50/2 + dx) and z > (50/2 - dx) and z < (50/2 + dx)){new_centre.set_pressure(100000/dx);}
...
face setup_face(int i, vector<centre> &points,string direction){
